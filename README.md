...
- First, move into backend(actual project folder).
```bash
  cd ./backend
```
- Create .env file
...
```bash
  docker-compose up
```
Finally, the project will be running on 5001 port.
You can test APIs with curl request or API GUI tools like Postman.